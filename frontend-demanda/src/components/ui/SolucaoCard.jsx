...
import { SERVICOS, LABELS_NECESSIDADE } from '../../constants/dados'

export default function SolucaoCard({ item, necessidades, onChangeNecessidade }) {
  return (
        ...
        {SERVICOS.map(serv => {
          ...
          return (
            <EscalaRadio
              ...
              label={serv.nome}
              name={chave}
              value={necessidades[chave] || null}
              onChange={(_, val) => onChangeNecessidade(item.codigo, serv.codigo, val)}
